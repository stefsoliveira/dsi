...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha br.ufrpe.bsi.dsi.dsi_app:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority br.ufrpe.bsi.dsi.dsi_app:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts br.ufrpe.bsi.dsi.dsi_app:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy br.ufrpe.bsi.dsi.dsi_app:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout br.ufrpe.bsi.dsi.dsi_app:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage br.ufrpe.bsi.dsi.dsi_app:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery br.ufrpe.bsi.dsi.dsi_app:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font br.ufrpe.bsi.dsi.dsi_app:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle br.ufrpe.bsi.dsi.dsi_app:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings br.ufrpe.bsi.dsi.dsi_app:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight br.ufrpe.bsi.dsi.dsi_app:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex br.ufrpe.bsi.dsi.dsi_app:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:font
     */
     ...
     * </table>
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name br.ufrpe.bsi.dsi.dsi_app:ttcIndex
     */
